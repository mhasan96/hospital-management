          ...
          <div className="row mt-3">
            <div className="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
              <h6 className="text-uppercase fw-bold mb-4">
                <i className="fas fa-gem me-3"></i> Life & Care Hospital
              </h6>
              <p>
                Life & Care Hospital specialises in specific areas of medicine.
                This approach enables us to provide world-class treatment and
